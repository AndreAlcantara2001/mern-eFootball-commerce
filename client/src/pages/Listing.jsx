        ...
        <main>
            ...
            <ul className='text-green-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6'>
              <li className='flex items-center gap-1 whitespace-nowrap '>
                <img src={efotEpic} alt='Epic' className='h-12 w-12 object-contain rounded-lg'/>
                {listing.bedrooms > 1
                  ? `${listing.bedrooms} epics `
                  : `${listing.bedrooms} epic `}
              </li>
              <li className='flex items-center gap-1 whitespace-nowrap '>
              <img src={efotPotw} alt='Potw' className='h-12 w-12 object-contain rounded-lg'/>
                {listing.bathrooms > 1
                  ? `${listing.bathrooms} potws `
                  : `${listing.bathrooms} potw `}
              </li>
              <li className='flex items-center gap-1 whitespace-nowrap '>
              <img src={efotBigTime} alt='BigTime' className='h-12 w-12 object-contain rounded-lg'/>
                {listing.parking ? 'Parking spot' : 'No Parking'}
              </li>
              <li className='flex items-center gap-1 whitespace-nowrap '>
              <img src={efotShowTime} alt='ShowTime' className=' h-12 w-12 object-contain rounded-lg'/>
