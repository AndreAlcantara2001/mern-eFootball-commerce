            ...
            <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
                <form className="flex flex-col gap-8">
                    ...
                    <div className="flex gap-2 flex-wrap items-center">
                        ...
                        <div className="flex gap-2">
                            <input type="checkbox" id='isepic' className='w-5' />
                            <span className="">Epic</span>
                        </div>
                        <div className="flex gap-2">
                            <input type="checkbox" id='isshowtime' className='w-5' />
                            <span className="">Show Time</span>
                        </div>
                        <div className="flex gap-2">
                            <input type="checkbox" id='islegend' className='w-5' />
                            <span className="">Legend</span>
                        </div>
                        <div className="flex gap-2">
                            <input type="checkbox" id='isbigtime' className='w-5' />
